...
},{}],"vue/Elm.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  watch: {
    flags: function flags(newValue, _) {
  ...
  mounted: function mounted() {
    ...
    if (this.app.ports.sendValue) {
      this.app.ports.sendValue.subscribe(function (x) {
        _this.$emit('update:flags', x);
      });
    }
  },
  render: function render(createElement, _) {
    return createElement("div");
  }
};
exports.default = _default;
        var $41b506 = exports.default || module.exports;
      
      if (typeof $41b506 === 'function') {
        $41b506 = $41b506.options;
      }
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$41b506', $41b506);
          } else {
            api.reload('$41b506', $41b506);
          }
        }
...
},{"vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.common.js"}],"Elm/Main.elm":[function(require,module,exports) {
(function(scope){
'use strict';
...
var author$project$Main$getValue = _Platform_incomingPort(
	'getValue',
...
var author$project$Main$sendValue = _Platform_outgoingPort(
	'sendValue',
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Get':
				var str = msg.a;
				return _Utils_Tuple2(str, elm$core$Platform$Cmd$none);
			case 'Del':
				var index = msg.a;
				var newModel = A2(
					elm$core$List$map,
				...
				return _Utils_Tuple2(
					newModel,
					author$project$Main$sendValue(newModel));
			default:
...
var author$project$Main$listItem = function (_n0) {
	var i = _n0.a;
	var str = _n0.b;
	return A2(
		elm$html$Html$li,
...
var author$project$Main$main = elm$browser$Browser$element(
	{
		...
		subscriptions: elm$core$Basics$always(
			author$project$Main$getValue(author$project$Main$Get)),
		update: author$project$Main$update,
		view: author$project$Main$view
	});
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$list(elm$json$Json$Decode$string))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"Get":["List.List String.String"],"Del":["Basics.Int"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});
...
},{}],"vue/App.vue":[function(require,module,exports) {
"use strict";
...
var _Main = _interopRequireDefault(require("../Elm/Main.elm"));
...
var _default = {
  ...
  data: function data() {
    return {
      inputData: "",
      listData: [],
      elmApp: _Main.default.Elm.Main
    };
  },
  methods: {
    addList: function addList() {
      this.listData = this.listData.concat(this.inputData);
      this.inputData = "";
    }
  }
};
exports.default = _default;
        var $4ed0e6 = exports.default || module.exports;
      
      if (typeof $4ed0e6 === 'function') {
        $4ed0e6 = $4ed0e6.options;
      }
    
        /* template */
        Object.assign($4ed0e6, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c(
    ...
    [
      _c("div", [
        ...
        _vm._v(" "),
        _c("button", { on: { click: _vm.addList } }, [_vm._v("Add")])
      ]),
      _vm._v(" "),
      _c("elm", {
        attrs: { flags: _vm.listData, elm: _vm.elmApp },
        on: {
          "update:flags": function($event) {
            _vm.listData = $event
          }
        }
      })
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$4ed0e6', $4ed0e6);
          } else {
            api.reload('$4ed0e6', $4ed0e6);
          }
        }
...
},{"./Elm":"vue/Elm.vue","../Elm/Main.elm":"Elm/Main.elm","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.common.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
},{"vue":"../node_modules/vue/dist/vue.common.js","./vue/App":"vue/App.vue"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
